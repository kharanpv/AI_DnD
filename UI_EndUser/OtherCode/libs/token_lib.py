...
# Below should always be in the order of string -> function as the indexing is fixed
list_of_apis = {
    "ChatGPT" : setup_chatgpt,
    "Hugging Face" : setup_huggingface,
    }
