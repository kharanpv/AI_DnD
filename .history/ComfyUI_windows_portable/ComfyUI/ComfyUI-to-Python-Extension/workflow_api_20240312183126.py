...
def main(positive_prompt: str, negative_prompt: str = None, num_samples: int = 5) -> None:
...
if __name__ == "__main__":
    ...
    # Add arguments
    parser.add_argument('positive_prompt', type=str, help='Positive prompt string')
    parser.add_argument('--negative_prompt', type=str, default=None, help='Negative prompt string (default: None)')
    parser.add_argument('--num_samples', type=int, default=5, help='Number of samples (default: 5)')

    # Parse the arguments
    args = parser.parse_args()

    # Call main() with parsed arguments
    main(args.positive_prompt, args.negative_prompt, args.num_samples)
